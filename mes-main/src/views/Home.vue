    ...
    <div class="tool">
      ...
      <div class="button-list">
        <el-tooltip placement="top">
          <template #content>主动降级，去除shadow+proxy</template>
          <el-switch
            size="large"
        ...
        <a-tooltip placement="top">
          <template v-slot:title>预加载+预执行</template>
          <el-switch
            size="large"
            class="switch button-gap"
            :disabled="disable"
        ...
        <a-tooltip placement="top">
          <template v-slot:title>主应用为hash模式</template>
          <a
        ...
        <a href="https://wujie-micro.github.io/doc/" target="_blank" class="docs button-gap"
          >文档</a
        >
      </div>
    </div>
